      ...
      <form onSubmit={handleSubmit} role="search" className="relative">
        <div className="relative">
          ...
          <input
            ...
            spellCheck={false}
            inputMode="search"
            className="glass-surface-sm w-full h-12 pl-12 pr-12 border-2 border-border bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary transition-all duration-200"
            style={{
              minWidth: '320px',
              minHeight: '48px',
